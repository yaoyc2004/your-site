const translations = {
  ...
  zh: {
    ...
    description: "美领科研出海帮助中国试剂、耗材和科研仪器设备厂商验证、进入并增长北美科研市场。",
    brandName: "美领科研出海",
    navServices: "服务",
    navModel: "模式",
    navAbout: "关于",
    navContact: "联系",
    heroEyebrow: "北美科研市场进入",
    heroTitle: "生命科学工具企业的北美 GTM 伙伴。",
    heroText: "美领科研出海帮助中国试剂、耗材和科研仪器设备厂商验证、进入并增长北美科研市场。",
    heroPrimary: "预约市场沟通",
    heroSecondary: "了解服务",
    whoEyebrow: "我们服务谁",
    whoTitle: "为准备测试北美市场的厂家而建。",
    whoTextOne: "我们服务正在评估北美需求、客户匹配度、渠道选择和销售准备度的新兴生命科学工具企业。",
    whoTextTwo: "第一阶段优先聚焦 RUO 科研产品：试剂、抗体、蛋白、ELISA 试剂盒、分子生物学试剂、耗材，以及部分实验室仪器和设备。",
    servicesEyebrow: "我们做什么",
    servicesTitle: "市场验证、客户开发和渠道准备。",
    serviceOneTitle: "GTM 市场验证冲刺",
    serviceOneText: "产品细分选择、竞品扫描、目标客户画像、潜在线索清单、早期触达测试，以及 go/no-go 建议。",
    serviceTwoTitle: "科学客户开发",
    serviceTwoText: "面向 PI 实验室、核心平台、biotech 团队、CRO/CDMO 和药企 discovery 用户进行有针对性的触达。",
    serviceThreeTitle: "分销渠道准备",
    serviceThreeText: "分销商 mapping、渠道 pitch 资料、利润和价格逻辑、技术 FAQ，以及合作伙伴触达准备。",
    serviceFourTitle: "销售资产本地化",
    serviceFourText: "为北美买家准备英文 one-pager、邮件序列、应用场景 pitch、竞品对比和会议脚本。",
    modelEyebrow: "合作模式",
    modelTitle: "先验证，再在市场有反应时放大。",
    phaseOneLabel: "第一阶段",
    phaseOneTitle: "4-6 周市场验证冲刺",
    phaseOneText: "明确产品定位，测试买家反馈，找到高匹配联系人，并判断下一步市场进入路径。",
    phaseTwoLabel: "第二阶段",
    phaseTwoTitle: "试用和早期销售支持",
    phaseTwoText: "支持会议准备、技术表达、试用协调、异议处理和报价跟进。",
    phaseThreeLabel: "第三阶段",
    phaseThreeTitle: "渠道开发",
    phaseThreeText: "准备面向分销商的销售资产、合作伙伴 mapping、pitch 材料和可复制的销售 playbook。",
    boundaryEyebrow: "聚焦式 GTM 伙伴",
    boundaryTitle: "从市场验证到渠道准备，专注把进入路径做清楚。",
    boundaryText: "美领科研出海帮助厂家明确产品定位、测试买家反馈、准备销售资产、识别高匹配线索，并打开合适的客户或渠道对话。产品履约、进口、物流、保修和法规执行，则由厂家或其指定运营伙伴协同完成。",
    aboutEyebrow: "关于美领科研出海",
    aboutTitle: "为市场进入中间这段复杂路，提供科学销售和 BD 支持。",
    aboutTextOne: "北美买家通常没有时间帮陌生供应商理解产品。他们关心的是：产品解决什么问题、和现有选择相比有什么差异、数据是否足够、出问题时谁负责。",
    aboutTextTwo: "美领科研出海帮助厂家把产品目录转化成聚焦的市场对话，用真实科研应用场景来组织定位、触达、渠道准备和早期客户发现。",
    contactEyebrow: "联系",
    contactTitle: "从一次聚焦的市场沟通开始。",
    contactText: "如果你正在评估生命科学试剂、耗材、仪器或科研设备产品线进入北美市场，可以发送一封简短邮件，说明产品类别和目标市场。",
    footerText: "© 2026 美领科研出海。面向北美科研市场的 GTM 咨询和商务拓展支持。"
  }
};
...
setLanguage(localStorage.getItem("merlin-language") || "en");
